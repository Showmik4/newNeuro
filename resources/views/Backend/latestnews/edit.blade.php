        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('latestnews.show') }}">News</a></li>
...
<div class="row">
    <div class="col-lg-8 offset-md-2">
        <div class="card">
            <div class="card-body">
                <form class="form" action="{{ route('latestnews.update', $latestnews->id) }}" method="POST"
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-actions mb-2">
                            <a href="{{ route('latestnews.show') }}"><button type="button"
