        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end mb-3">
                    <a href="{{ route('team.create') }}" class="btn btn-md btn-info "><i class="ft-plus"></i>Create
                        New</a>
                </div>
    ...
    $(document).ready(function () {
            $('#teamTable').DataTable({
                ...
                columns: [
                    ...
                    {title: 'Designation', data: 'designation', name: 'designation', className: "text-center", orderable: false, searchable: false},  
