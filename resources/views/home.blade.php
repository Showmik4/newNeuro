                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                ...
                                <p class="text-muted mb-1 text-truncate">Total Room</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                ...
                                <h3 class="text-dark mt-1"><span data-plugin="counterup"></span></h3>
                                <p class="text-muted mb-1 text-truncate">Total Package</p>
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <a href="">
                                    ...
                                    <p class="text-muted mb-1 text-truncate">Total Reservation</p>
                                </a>
                            </div>
                        </div>
                    </div> <!-- end row-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="{{url('/public/assets/images/users/user-2.jpg')}}" alt="contact-img"
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="{{url('/public/assets/images/users/user-3.jpg')}}" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm" />
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="{{url('/public/assets/images/users/user-4.jpg')}}" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm" />
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="{{url('/public/assets/images/users/user-5.jpg')}}" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm" />
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 36px;">
                                        <img src="{{url('/public/assets/images/users/user-6.jpg')}}" alt="contact-img"
                                            title="contact-img" class="rounded-circle avatar-sm" />
                                    </td>
