...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add User Type</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form class="form" action="{{ route('userType.store') }}" method="post">
                        @csrf
                        <div class="form-body">
                            <div class="form-group mb-2">
                                <label class="form-label">User Type Name</label>
                                <input type="text" class="form-control" placeholder="User Type Name" value="{{ old('type_name') }}" name="type_name" required>
